  ...
  return (
    <div>
      <section  aria-labelledby="hero-heading">
        <div className="bg-linear-to-r from-red-500 to-pink-700 rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-white text-blue-600 font-bold px-6 py-3 rounded-xl hover:bg-indigo-500 hover:text-black transition-all transform hover:scale-105 shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600">
                Start Shopping Now
              </button>
